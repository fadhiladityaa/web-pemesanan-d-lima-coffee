<nav class="navbar bg-[#947257] shadow-lg flex justify-between z-40 lg:p-4 fixed">
    <div class="font-[Sriracha] pl-[16px] flex gap-2 items-center">
