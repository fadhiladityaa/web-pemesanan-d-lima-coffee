<div class="lg:mt-20">
    <div class="bg-white rounded-lg shadow lg:mt-2 mb-6">
        ...
        <td class="px-6 py-4 whitespace-nowrap">
            <span
                class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $order->tipe_pesanan === 'Take away' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800' }}">{{ $order->tipe_pesanan }}</span>
        </td>
        <td class="px-6 py-4 whitespace-nowrap">
            <span
