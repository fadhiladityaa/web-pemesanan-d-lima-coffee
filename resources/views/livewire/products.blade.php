<div class="lg:mb-10">
    ...
    @if(isset($activePromo) && $activePromo)
        <div class="relative top-12 overflow-hidden rounded-xl bg-gradient-to-r from-[#fff8e1] to-[#fff3e0] border border-amber-200 shadow-sm p-4 sm:p-6 mb-12 sm:mt-0 animate-fade-in-down">
            {{-- Hiasan Background --}}
