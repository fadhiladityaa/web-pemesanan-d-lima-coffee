                ...
                <div class="cart-container w-full shadow-medium rounded-md p-[16px]">
                    ...
                    <div class="cart-items-container mt-4">
                        ...
                        <div
                            ...
                            <img src="{{ asset('img/contoh-kopi-2.png') }}" class="sm:w-36 lg:w-24 lg:h-24"
                                alt="contoh kopi">
                            <div
                                class="pricing-container flex sm:mt-1 sm:mr-[15rem] lg:mr-0 flex-col lg:mt-0 lg:ml-2 lg:gap-1 gap-2">
